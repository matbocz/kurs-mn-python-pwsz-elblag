...
#Wartosci 'x' dla danych interpolowanych generuj '€žgesto'€, np. z krokiem 0.08.
...
xyv=[]
xyv.append([i for i in np.arange(0,3.3,0.4)])
xyv.append([np.sin(i**2) for i in np.arange(0,3.3,0.4)])
